...
<RocketList>
	...
	<li>
		<strong>🔊 Salon des Étudiants</strong> : un canal vocal accessible
		uniquement par les étudiants
	</li>
	<li>
	...
	<li>
		<strong>🔊 Salle de classe</strong> : un canal vocal pour les cours à
		distance, renommable par les Professeurs. Ce canal reprend son nom
		originel lorsqu'il est vide.
	</li>
</RocketList>
