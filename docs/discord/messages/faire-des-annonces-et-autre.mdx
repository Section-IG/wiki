...
<Image src='/img/discord/channel-mention.gif' alt='Channel mention GIF' />
...
<Image src='/img/discord/user-mention.gif' alt='User mention GIF' />
...
<Image src='/img/discord/role-mention.gif' alt='Role mention GIF' />
