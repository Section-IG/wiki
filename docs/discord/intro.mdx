...
<Image src='/img/discord/DiscordGuide-banner.png' alt='Banner DiscordGuide' />

Discord est un moyen de communication important au sein de la section Informatique de Gestion, et j'ose l'imaginer également dans d'autres groupes étudiants.
...
Tu retrouveras plus loin dans ces articles de nombreuses anecdotes, conseils et informations qui, je l'espère, t'aideront à mieux comprendre l'outil.

Cependant, si tu souhaites avoir des informations plus précises, je te conseille de te rendre sur ces différents sites:
